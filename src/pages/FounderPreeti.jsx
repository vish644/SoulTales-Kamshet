...
const FounderPreeti = () => {
  return (
    <section className="relative overflow-hidden">
      <div className="max-w-360 mx-auto aspect-auto md:aspect-1440/900 flex flex-col md:flex-row items-stretch min-h-screen">
        {/* Content panel — dark, textured background image with navy tint */}
        <div className="relative w-full md:w-1/2 overflow-hidden order-2 md:order-1">
          <div
            className="absolute inset-0 bg-cover bg-center"
            style={{ backgroundImage: `url(${bgImage})` }}
          />
          ...
          <div className="relative z-10 h-full px-6 py-10 sm:px-10 sm:py-12 lg:px-16 lg:py-14 flex flex-col justify-center gap-4">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white leading-tight">
              Who Is Running This
            </h1>
        ...
        {/* Photo — flush against the panel, no margin/padding between them */}
        <div className="relative w-full md:w-1/2 aspect-[4/3] md:aspect-auto order-1 md:order-2">
          <img
            src={preetiImg}
            alt="Preeti Toraskar standing outdoors among trees"
            className="w-full h-full object-cover"
